...
- [Thông qua Cấu hình profile trên IOS](#thông-qua-cấu-hình-profile)
- [Thêm IPv6 vào mạng trên IOS](#thêm-ipv6-vào-mạng-trên-ios)
- [Thêm IPv4 vào mạng trên IOS với IP được liên kết](#thêm-ipv6-với-mạng-trên-ios-với-ip-được-liên-kết)
...
- [Thêm IPv4 vào mạng trên Windows với IP được liên kết](#thêm-ipv6-với-mạng-trên-windows-với-ip-được-liên-kết)
- [YogaDNS](#yogadns)
- [Với MacOS](#với-macos)
...
- [Thêm IPv4 vào mạng trên MacOS với IP được liên kết](#thêm-ipv6-với-mạng-trên-macos-với-ip-được-liên-kết)
...
- [Thêm IPv4 vào mạng trên Linux với IP được liên kết](#thêm-ipv6-với-mạng-trên-linux-với-ip-được-liên-kết)
...
- [Thêm IPv4 vào mạng trên Chrome OS với IP được liên kết](#thêm-ipv6-với-mạng-trên-chrome-os-với-ip-được-liên-kết)
...
- [Thêm IPv4 vào mạng trên Routers với IP được liên kết](#thêm-ipv6-với-mạng-trên-crouters-với-ip-được-liên-kết)
- [Kết](#kết)
